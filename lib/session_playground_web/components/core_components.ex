defmodule SessionPlaygroundWeb.CoreComponents do
  @moduledoc """
          ...
          <div class="p-4">
            <div class="flex items-start">
              <div class="flex-shrink-0">
                <Heroicons.check_circle outline class="h-6 w-6 text-green-400" />
              </div>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SessionPlaygroundWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SessionPlaygroundWeb.Gettext, "errors", msg, opts)
    end
  end
